...
@ApiModel(description = "已審核案件集合")
@Entity
public class ReviewedCaseQueryDto implements Serializable {
	...
	@ApiModelProperty(notes = "更新時間，格式：yyyy/MM/dd")
	@Column(name = "UpdateTime")
	private Date updateTime;

	public ReviewedCaseQueryDto() {
		
	}

	public ReviewedCaseQueryDto(KgoCaseMain cm, KgoCaseset s) {
		this.caseId = cm.getCaseId();
		this.applyDate = cm.getApplyDate();
		this.applyUser = cm.getApplyUserName();
		...
		this.updateTime = cm.getUpdateTime();
	}
