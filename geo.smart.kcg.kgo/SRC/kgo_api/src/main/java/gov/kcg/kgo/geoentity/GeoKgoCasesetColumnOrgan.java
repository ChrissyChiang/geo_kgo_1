...
@Entity
@DynamicInsert
@Table(name = "GEO_KGO_CASESET_COLUMN_ORGAN", schema = "dbo")
public class GeoKgoCasesetColumnOrgan implements Serializable {

    private static final long serialVersionUID = 1L;

    @EmbeddedId
    private GeoKgoCasesetColumnOrganPK id;
    ...
    public GeoKgoCasesetColumnOrganPK getId() {
        return id;
    }

    public void setId(GeoKgoCasesetColumnOrganPK id) {
        this.id = id;
    }
