...
/**
 * 後台-線上預約臨櫃-編輯：預約表單欄位維護初始化 ViewForm
 */
@ApiModel(description = "後台-線上預約臨櫃-編輯：預約表單欄位維護初始化 ViewForm")
public class GeoAppointmentFormColumnHomeViewForm extends BaseViewForm {
