 ...
 *
 */
public class PropertyInfoMyDataHelper extends KgoMydataBaseServiceHelper {

	/**
	 * Instantiates a new service helper.
	 */
	public PropertyInfoMyDataHelper() {
		super();
	}
	...
	private static class Loader {
		...
		private static final PropertyInfoMyDataHelper instance = new PropertyInfoMyDataHelper();
	}
	 ...
	 */
	public static PropertyInfoMyDataHelper getInstance() {
