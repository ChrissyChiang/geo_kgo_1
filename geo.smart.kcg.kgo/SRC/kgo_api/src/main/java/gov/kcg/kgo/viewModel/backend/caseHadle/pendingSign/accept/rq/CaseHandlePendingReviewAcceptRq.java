package gov.kcg.kgo.viewModel.backend.caseHadle.pendingSign.accept.rq;
...
@ApiModel(description = "後台案件處理-待簽收匣-簽收 rq")
public class CaseHandlePendingReviewAcceptRq extends ApiRequest {
