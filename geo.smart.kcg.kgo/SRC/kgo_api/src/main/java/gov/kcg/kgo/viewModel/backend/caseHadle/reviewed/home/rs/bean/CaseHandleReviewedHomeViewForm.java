package gov.kcg.kgo.viewModel.backend.caseHadle.reviewed.home.rs.bean;
...
/**
 * 後台案件處理-已審核匣-初始畫面 View Form
 */
@ApiModel(description = "後台案件處理-已審核匣-初始畫面 View Form")
public class CaseHandleReviewedHomeViewForm extends BaseViewForm {
