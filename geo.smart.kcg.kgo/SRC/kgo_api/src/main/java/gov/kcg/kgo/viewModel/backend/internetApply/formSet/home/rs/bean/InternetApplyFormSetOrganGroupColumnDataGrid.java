 ...
 * 網路申辦-表單設定-機關審核表單群組維護-欄位資料集合
 */
@ApiModel(description = "網路申辦-表單設定-機關審核表單群組維護-欄位資料集合")
public class InternetApplyFormSetOrganGroupColumnDataGrid {
    ...
    public InternetApplyFormSetOrganGroupColumnDataGrid() {
    }
