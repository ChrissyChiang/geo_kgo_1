...
public class CityCoinMissionInfo {
	...
	private Integer organizerSeqNavigation;
	...
	private Object missionTense;

	@ApiModelProperty(value = "任務類型	（A:Area 場域、R:Read 閱讀文章、Q:Questionnaire 問卷）")
	private String Type;
	...
	@ApiModelProperty(value = "目標對象性別（F:女、M:男）")
	...
	public Integer getOrganizerSeqNavigation() {
		return organizerSeqNavigation;
	}

	public void setOrganizerSeqNavigation(Integer organizerSeqNavigation) {
	...
	public Object getMissionTense() {
		return missionTense;
	}

	public void setMissionTense(Object missionTense) {
		this.missionTense = missionTense;
	}
