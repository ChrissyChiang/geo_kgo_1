package gov.kcg.kgo.viewModel.commonApi.getUserLogJson.rq;

import gov.kcg.kgo.viewModel.commonApi.common.rq.ApiCityCommonRequest;
import io.swagger.annotations.ApiModel;
import io.swagger.annotations.ApiModelProperty;

@ApiModel(description = "提供操作軌跡紀錄json log rq")
public class GetUserLogJsonActionRq extends ApiCityCommonRequest {
	...
	@ApiModelProperty(value = "查詢機關代碼", position=4)
