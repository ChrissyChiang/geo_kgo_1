package gov.kcg.kgo.viewModel.frontend.bidServiceMenu.query.rs.bean;
...
/**
 * 申辦服務選單-申辦案件數查詢 View Form
 */
@ApiModel(description = "申辦服務選單-申辦案件數查詢 View Form")
public class BidServiceMenuQueryViewForm extends BaseViewForm {
