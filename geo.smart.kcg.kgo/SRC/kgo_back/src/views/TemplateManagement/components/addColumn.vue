      ...
      <validation-observer ref="formFieldEditObserver">
        <div class="panel panel-fsm">
          ...
          <div class="fsm-form">
              ...
              <div class="col-xs-12 form-group col-md-12">
                ...
                <div class="col-sm-8">
                  <validate-container :rules="'required'">
                    <input v-model="form.columnName" class="form-control" type="text" />
                  </validate-container>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-xs-12 form-group col-md-12">
                <label for="input_event" class="col-sm-4 control-label">欄位型態</label>
                <div class="col-sm-4">
                  <validate-container :rules="'required'">
                    <base-select
            ...
            <div v-if="isShowIntgrApiId" class="row">
              <div class="col-xs-12 form-group col-md-12">
                <label for="input_event" class="col-sm-4 control-label">城市資料平台Api</label>
                <div class="col-sm-8">
                  <validate-container :rules="'required'">
                    <input v-model="form.columnValue" class="form-control" type="text" />
                  </validate-container>
                </div>
              </div>
            </div>
            ...
            <div v-if="isShowLengthField" class="row">
              <div class="col-xs-12 form-group col-md-12">
                <label for="input_event" class="col-sm-4 control-label">欄位長度</label>
                <div class="col-sm-8">
                  <validate-container :rules="'required'">
                    <input
                      v-model="form.length"
            ...
            <div v-if="isShowFil" class="row">
              <div class="col-xs-12 form-group col-md-12">
                <label for="input_event" class="col-sm-4 control-label">附件類型</label>
                <div class="col-sm-7">
                  <validate-container :rules="'required'">
                    <base-check-list
            ...
            <div class="row">
              <div class="col-xs-12 form-group col-md-12">
                <label for="input_event" class="col-sm-4 control-label">是否必填</label>
                <div class="col-sm-8">
                  <validate-container :rules="'required'">
                    <base-select
                      ...
                      required
                      :select=" (form.columnId =='Email' || form.columnId =='CellPhone' || form.columnId =='Name' || form.columnId =='ID') ? '1' : form.isMustKey"
                      :disabled=" (form.columnId =='Email' || form.columnId =='CellPhone' || form.columnId =='Name' || form.columnId =='ID') "
                    />
                  </validate-container>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-xs-12 form-group col-md-12">
                <label for="input_event" class="col-sm-4 control-label">備註說明</label>
                <div class="col-sm-8">
          ...
          <div v-if="form.columnType == 'M'">
            <div class="add-row-button">
              ...
              <button type="button" class="btn btn-warning text-right" @click="addComplexRow">
                <i class="fa fa-external-link" aria-hidden="true"></i>
                新增複合列
              </button>
            </div>
            <div v-for="(fieldList, rowIndex) in form.complex" :key="rowIndex">
              ...
              >
                <transition-group type="transition" name="flip-list" class="fieldContent">
                  <li
...
export default {
  ...
  computed: {
    ...
    isDisabled() {
      ...
      return needShowDrp.includes(this.form.columnId) && this.form.seq != '' ? true : false
  ...
  watch: {
    ...
    'form.columnType': {
      handler() {
        ...
        if(this.form.columnType == 'M'){
          this.isShowMyData = false
        }
        else{
          this.isShowMyData = true
        }
      }
    }
  },
  ...
  methods: {
    ...
    async initData(data, groupSeq, editIndex, columnIds) {
